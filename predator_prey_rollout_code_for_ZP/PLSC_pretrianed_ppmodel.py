...
if __name__ == '__main__':
    ...
    results = Parallel(n_jobs=12)(delayed(processing_episode_wrapper)(
    ...
    ) for eId in range(1,101) for title in titles)
    ...
    with open(f'{video_path}PLSC_results_dict_NP.pkl', 'wb') as f:
